...
function initContactForm() {
  ...
  form.addEventListener("submit", (e) => {
    ...
    // Required by FormSubmit to avoid captcha redirects on AJAX
    data._captcha = "false";

    fetch("https://formsubmit.co/ajax/Vishwakarmasuraj089504@gmail.com", {
      method: "POST",
      headers: {
